...
export default {
  props: ['items', 'notifySource', 'supplierClass', 'branchKey', 'branchSlot', 'pageCount', 'count', 'pageSize'],
  ...
  data() {
    return {
      ...
      fields: [
        ...
        {
          key: 'notifyText',
          label: IMText.general.fshi0012.notifySource,
  ...
  methods: {
    onRowClicked(data) {
      ...
      switch (this.notifySource) {
        case NotifySource.wasteCompany.key:
          navigation.sshi0003(data.customerCode);
          break;
        case NotifySource.deliveryCompany.key:
          if (this.supplierClass === SupplierClass.deliveryCompany.key) {
            navigation.sshi0012(data.supplierCode);
          } else {
            const params= {
        ...
        case NotifySource.system.key:
          navigation.sshi0006(data.branchCode);
          break;
        default:
          break;
      }
