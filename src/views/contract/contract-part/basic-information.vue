    ...
    <table class="basic-information table table-box table-sm headTable">
      ...
      <tr>
        <td class="titleColumn width-column">
          <span class="asterisk">*</span>区間
        </td>
        <td colspan="3" class="dropdown-checkbox border-right-none">
          <b-form-select
            size="sm"
            v-model="item.sectionNumber"
            :options="sectionNumberOption"
            :disabled="disableByWasteClass || imgStatus"
            @change="onChangeSectionNumber($event)"
      ...
      <tr>
        ...
        <td colspan="11">
          <b-form-textarea size="lg" no-resize v-model="item.memo" @change="onChangeValue"></b-form-textarea>
        </td>
      </tr>
    </table>
  </div>
